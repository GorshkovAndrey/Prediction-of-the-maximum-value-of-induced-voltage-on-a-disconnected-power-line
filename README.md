...
Вторая операция – определение неизвестных коэффициентов ![Alt text](image-3.png) линейной регрессии наведенного напряжения посредством машинного обучения на результатах натурных измерений наведенного напряжения.

Третья операция – вычисление значения u_max по следующему выражению [1]

![Alt text](image-1.png)

где ![Alt text](image-2.png) – максимально возможные значения модулей токов симметричных составляющих в начале и конце i-ой влияющей ЛЭП.
