...
Из решения уравнений Максвелла для электромагнитного поля [1], следует, что наведенное напряжение ![Alt text](image-7.png) на отключенной ЛЭП определяется следующим выражением (подчеркивание означает, что величина относится к множеству ℂ комплексных чисел)
...
Первая операция – проведение на отключенной ЛЭП (до проведения на ней работ) в течении некоторого интервала времени серии из M синхронизированных измерений комплексных значений наведенного напряжения и фазных токов влияющих ЛЭП.
