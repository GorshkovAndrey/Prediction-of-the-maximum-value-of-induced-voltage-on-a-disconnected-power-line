...
Вторая операция – определение неизвестных коэффициентов ![Alt text](image.png) линейной регрессии наведенного напряжения посредством машинного обучения на результатах синхронизированных измерений наведенного напряжения и токов влияющих ЛЭП.
