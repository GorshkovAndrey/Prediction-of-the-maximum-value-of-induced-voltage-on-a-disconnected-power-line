...
Из решения уравнений Максвелла для электромагнитного поля, следует, что наведенное напряжение <u>u</u> на отключенной ЛЭП определяется следующим выражением (подчеркивание означает, что величина относится к множеству ℂ комплексных чисел)
